...
VALUES
  (1, 'Site Institucional', 'Criacao do site da empresa', 'EM_ANDAMENTO', '2025-12-31 18:00:00', 15000.00, NOW(), 1),
  (2, 'App Mobile', 'Desenvolvimento do app Android e iOS', 'EM_PLANEJAMENTO', '2026-03-01 18:00:00', 28000.00, NOW(), 1),
  (3, 'Sistema ERP', 'Implantacao do ERP interno', 'CONCLUIDO', '2024-06-30 18:00:00', 50000.00, NOW(), 1);
